...
// h3.innerText=playlistData[1]["title"];
...
let playlistcardlist = document.querySelectorAll(".playlist-card")
// console.log(playlistcardlist)
playlistcardlist.forEach(function (card){
    card.addEventListener("click",function(){
      ...
      videoPlayer.src = `https://player.vimeo.com/video/${
        ...
        let vediotitle = document.getElementById("video-title");
        vediotitle.innerText = videoPlaySectionData[card.id-1]["title"]

        let VedioDicription = document.getElementById("video-description")
        VedioDicription.innerText=videoPlaySectionData[card.id-1]["description"]
